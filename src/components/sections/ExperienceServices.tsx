...
export default function ExperienceServices() {
  return (
    <section id="experience" className="py-16 md:py-24 pb-28 md:pb-24 relative px-4 md:px-12 max-w-5xl mx-auto min-h-screen">
      ...
      <div className="relative space-y-12 before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-1 before:bg-gradient-to-b before:from-[var(--primary)] before:via-[var(--secondary)] before:to-transparent">
        {experienceData.map((exp, i) => (
          ...
          >
            ...
            {/* Content Box */}
            <div className={`w-[calc(100%-4rem)] md:w-[calc(50%-4rem)] glass p-5 sm:p-8 rounded-2xl sm:rounded-3xl border border-white/5 hover:border-[var(--primary)]/40 hover:shadow-[0_0_40px_rgba(108,99,255,0.1)] transition-all duration-500 group-hover:-translate-y-2`}>
              ...
              <h3 className="font-space font-bold text-lg sm:text-2xl text-white group-hover:text-[var(--primary)] transition-colors duration-300">
                {exp.role}
              </h3>
